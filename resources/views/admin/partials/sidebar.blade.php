<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- Program  --}}
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#program" class="nav-link {{Route::is('yyy.*') ? 'active' : ''}}"
                ...
                <div class="collapse {{Route::is('yyy*') ? 'show' : ''}}" id="program">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link {{Route::is('yy.create') ? 'active' : ''}}" href="{{route('Program.create')}}">
                                <span class="sidenav-mini-icon"> K </span>
                                <span class="sidenav-normal"> Tambah Program </span>
                            </a>
                        </li>      
                        <li class="nav-item ">
                            <a class="nav-link {{Route::is('yyy.index') ? 'active' : ''}}" href="{{route('Program.index')}}">
                                <span class="sidenav-mini-icon"> K </span>
